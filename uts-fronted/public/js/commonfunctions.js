function addMoreFiles(appendDivId){
	...
	$('#addMore_'+appendDivId).append('<div class="form-group" id="filescount-'+filesCount+'"><input class="form-control" type="file" id="taxFile_'+filesCount+'" name="taxfile-'+appendDivId+'[]"> &nbsp;&nbsp;<a href="javascript:void(0);"  onclick="removeFileInput('+filesCount+')"><span class="rembtn"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></span></a></div>');
